...
namespace Moon.OData
{
    ...
    public enum AllowedFunctions
    {
        ...
        /// <summary>
        /// A value that corresponds to allowing 'TotalOffsetMinutes' function in $filter.
        /// </summary>
        TotalOffsetMinutes = 0x80000,

        /// <summary>
        /// A value that corresponds to allowing 'Now' function in $filter.
        /// </summary>
        Now = 0x100000,

        /// <summary>
        /// A value that corresponds to allowing 'MaxDateTime' function in $filter.
        /// </summary>
        MaxDateTime = 0x200000,

        /// <summary>
        /// A value that corresponds to allowing 'MinDateTime' function in $filter.
        /// </summary>
        MinDateTime = 0x400000,

        /// <summary>
        /// A value that corresponds to allowing 'TotalSeconds' function in $filter.
        /// </summary>
        TotalSeconds = 0x800000,
        ...
        /// </summary>
        AllStringFunctions = Contains | EndsWith | StartsWith | Length | IndexOf | Substring | ToLower | ToUpper | Trim | Concat,

        /// <summary>
        /// A value that corresponds to allowing all datetime related functions in $filter.
        /// </summary>
        AllDateTimeFunctions = Year | Month | Day | Hour | Minute | Second | FractionalSeconds | Date | Time | TotalOffsetMinutes | Now | MaxDateTime | MinDateTime | TotalSeconds,
        ...
        /// </summary>
        AllFunctions = AllStringFunctions | AllDateTimeFunctions | AllMathFunctions | IsOf | Cast | Any | All
    }
}